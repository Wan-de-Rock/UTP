...
public class Main {
  public static void main(String[] args) {
    ...
    List<Integer> m1 = list1.union(list2);  // oczywiście, możјna podstawiać na List
    System.out.println(m1);
    // możјna wykonywać wszystkie operacje z interfejsu List, np:
    m1.add(11);
    System.out.println(m1);
    ...
    // Metoda unique -zwraca nowy Xlist bez duplikatow
